...
var Counter = () => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Card, { className: "w-full max-w-sm", children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(CardHeader, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(CardTitle, { className: "text-center", children: "Counter" }) }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(CardContent, { className: "flex flex-col items-center space-y-4", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: "text-4xl font-bold", children: count }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex space-x-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Button, { variant: "outline", onClick: () => setCount(count - 1), className: "w-24", children: "Decrement" }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Button, { onClick: () => setCount(count + 1), className: "w-24", children: "Increment" })
      ] })
    ] })
  ] });
};
...
var Page = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "min-h-screen bg-gradient-to-b from-gray-100 to-gray-200 flex flex-col items-center justify-center p-4", children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("h1", { className: "text-4xl font-bold mb-8 text-gray-800", children: [
      data.users[0].name,
      "'s Profile"
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Counter_default, {})
  ] });
};
var posts_default = Page;
if (typeof window !== "undefined") {
  ...
  try {
    ...
    reactDom.hydrateRoot(
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(PylonPageLoader, { client, Page, pageProps: pylonData.pageProps, cacheSnapshot: pylonData.cacheSnapshot })
    );
  } catch (error) {

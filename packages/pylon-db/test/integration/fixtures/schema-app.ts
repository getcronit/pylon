 ...
 */
import {Model, model, id, text, boolean, timestamp, foreignKey, hasMany, manyToMany, enumColumn} from '../../../src/index.js'
...
export class User extends Model {
  ...
  role = enumColumn(['ADMIN', 'USER'] as const, {default: 'USER'})

...
describe('Esbuild useDataStaticAnalyzer', () => {
  ...
  it('should securely inject selectors into empty useData calls', async () => {
    ...
    expect(outputCode).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_tests/testA.tsx
      import { useData } from "@getcronit/pylon/pages";
      function Component() {
        const data = useData({
  ...
  it('should securely inject selectors into useData calls with existing config arguments', async () => {
    ...
    const outputCode = result.outputFiles[0].text
    expect(outputCode).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_tests/testB.tsx
      import { useData } from "@getcronit/pylon/pages";
      function Component() {
        const data = useData({
          prepare: ({ query: __pylonQuery }) => {
  ...
  it('should translate deep array mappings with arguments dynamically at build-time', async () => {
    ...
    const outputCode = result.outputFiles[0].text
    expect(outputCode).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_tests/testC.tsx
      import { useData } from "@getcronit/pylon/pages";
      function Component() {
        const data = useData({
          prepare: ({ query: __pylonQuery }) => {
  ...
  it('should preserve locally scoped variables in injected selectors natively', async () => {
    ...
    const outputCode = result.outputFiles[0].text
    expect(outputCode).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_tests/testE.tsx
      import { useData } from "@getcronit/pylon/pages";
      function Component() {
        const myFetchLimit = 50;
        const data = useData({
  ...
  it('should flawlessly preserve React State variables for dynamic requests', async () => {
    ...
    const outputCode = result.outputFiles[0].text
    expect(outputCode).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_tests/testF.tsx
      import { useState } from "react";
      import { useData } from "@getcronit/pylon/pages";
      function Component() {
        const [pageOffset, setPageOffset] = useState(0);
  ...
  it('should handle dynamic function calls with primitives in JSX (dyno case)', async () => {
    ...
    expect(outputCode).toMatchInlineSnapshot(`
      ...
      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_tests/test_dyno.tsx
  ...
  it('should correctly resolve selectors across multiple files in a real build scenario', async () => {
    ...
    const outputCode = result.outputFiles[0].text
    expect(outputCode).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_tests/Page.tsx
      import { useData } from "@getcronit/pylon/pages";

      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_tests/UserCard.tsx
  ...
  it('should handle nested cross-file resolution across three levels', async () => {
    ...
    const outputCode = result.outputFiles[0].text
    expect(outputCode).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_tests/Parent.tsx
      import { useData } from "@getcronit/pylon/pages";

      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_tests/GrandChild.tsx
      import { jsx } from "react/jsx-runtime";
      function GrandChild({ info }) {
        return /* @__PURE__ */ jsx("span", { children: info.detail });
      }

      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_tests/Child.tsx
  ...
  it('should handle mixed prop usage and standalone useData in the same component', async () => {
    ...
    expect(outputCode).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_tests/AppPage.tsx
      import { useData as useData2 } from "@getcronit/pylon/pages";

      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_tests/SharedComponent.tsx
      import { useData } from "@getcronit/pylon/pages";
      import { jsx, jsxs } from "react/jsx-runtime";
...
describe('Realistic NextJS App with useData', () => {
  ...
  it('should handle a Dashboard page with stats, notifications, and layout', async () => {
    ...
    expect(out).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/Dashboard.tsx
      import { useData } from "@getcronit/pylon/pages";

      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/components/Sidebar.tsx
      import { jsx, jsxs } from "react/jsx-runtime";
      ...
      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/components/Layout.tsx
      ...
      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/components/StatCard.tsx
      ...
      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/components/Notification.tsx
      ...
      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/components/Avatar.tsx
      import { jsx as jsx5 } from "react/jsx-runtime";
      function Avatar({ user }) {
        return /* @__PURE__ */ jsx5("img", { src: user.avatarUrl, alt: user.displayName });
      }

      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/components/UserCard.tsx
  ...
  it('should handle a Blog listing page with PostCards and nested tag arrays', async () => {
    ...
    const out = result.outputFiles[0].text
    expect(out).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/Blog.tsx
      import { useData } from "@getcronit/pylon/pages";

      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/components/Badge.tsx
      import { jsx } from "react/jsx-runtime";
      function Badge({ label, color }) {
        return /* @__PURE__ */ jsx("span", { style: { background: color }, children: label });
      }

      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/components/PostCard.tsx
      import { jsx as jsx2, jsxs } from "react/jsx-runtime";
  ...
  it('should handle a deeply nested Profile page with user, posts, and comments', async () => {
    ...
    const out = result.outputFiles[0].text
    expect(out).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/Profile.tsx
      import { useData } from "@getcronit/pylon/pages";
      ...
      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/components/ProfileHeader.tsx
      import { jsx as jsx2, jsxs } from "react/jsx-runtime";
      ...
      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/components/CommentThread.tsx
  ...
  it('should handle a Settings page with two independent useData calls', async () => {
    ...
    const out = result.outputFiles[0].text
    expect(out).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/Settings.tsx
      import { useData } from "@getcronit/pylon/pages";
      ...
      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/components/ThemePreview.tsx
      import { jsx as jsx3, jsxs as jsxs2 } from "react/jsx-runtime";
  ...
  it('should handle a full app with Layout + child component that has its own useData', async () => {
    ...
    const out = result.outputFiles[0].text
    expect(out).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/AppPage.tsx
      import { useData as useData2 } from "@getcronit/pylon/pages";
      ...
      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/components/ActivityFeed.tsx
      import { useData } from "@getcronit/pylon/pages";
      import { jsx as jsx3, jsxs as jsxs3 } from "react/jsx-runtime";
  ...
  it('should preserve React state variables and handle conditional field access', async () => {
    ...
    const out = result.outputFiles[0].text
    expect(out).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/Search.tsx
      import { useState } from "react";
      import { useData } from "@getcronit/pylon/pages";
      import { jsx, jsxs } from "react/jsx-runtime";
      function SearchPage() {
  ...
  it('should resolve selectors across a four-level deep component tree', async () => {
    ...
    const out = result.outputFiles[0].text
    expect(out).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/StorePage.tsx
      import { useData } from "@getcronit/pylon/pages";

      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/components/PriceTag.tsx
      import { jsx, jsxs } from "react/jsx-runtime";
      ...
      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/components/ProductCard.tsx
      import { jsx as jsx2, jsxs as jsxs2 } from "react/jsx-runtime";
      ...
      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/components/ProductSection.tsx
      import { jsx as jsx3, jsxs as jsxs3 } from "react/jsx-runtime";
  ...
  it('should inject selectors alongside existing useData config', async () => {
    ...
    const out = result.outputFiles[0].text
    expect(out).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/ConfiguredPage.tsx
      import { useData } from "@getcronit/pylon/pages";
      import { jsx, jsxs } from "react/jsx-runtime";
  ...
  it('should correctly isolate selectors when building multiple pages', async () => {
    ...
    expect(outA).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/PageA.tsx
      import { useData } from "@getcronit/pylon/pages";
    ...
    expect(outB).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/PageB.tsx
      import { useData } from "@getcronit/pylon/pages";
      import { jsxs } from "react/jsx-runtime";
      function PageB() {
        const data = useData({
  ...
  it('should handle double-nested array mappings with arguments at each nesting level', async () => {
    ...
    const out = result.outputFiles[0].text
    expect(out).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/OrgPage.tsx
      import { useData } from "@getcronit/pylon/pages";
      import { jsx, jsxs } from "react/jsx-runtime";
      function OrgPage() {
        const data = useData({
  ...
  it('should handle a custom hook wrapping useData', async () => {
    ...
    const out = result.outputFiles[0].text
    expect(out).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/ProfileWithLocalHook.tsx
      import { useData } from "@getcronit/pylon/pages";
  ...
  it('should handle multiple data paths passed to the same component', async () => {
    ...
    expect(out).toMatchInlineSnapshot(
      `
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/MultiUser.tsx
      import { useData } from "@getcronit/pylon/pages";
  ...
  it('should handle conditional and ternary JSX rendering', async () => {
    ...
    expect(out).toMatchInlineSnapshot(
      `
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/Conditional.tsx
      import { useData } from "@getcronit/pylon/pages";
  ...
  it('should handle barrel file re-exports', async () => {
    ...
    expect(out).toMatchInlineSnapshot(
      `
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/Barrel.tsx
      import { useData } from "@getcronit/pylon/pages";

      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/components/A.tsx
      import { jsx } from "react/jsx-runtime";
      function ComponentA({ data }) {
        return /* @__PURE__ */ jsx("div", { children: data.fieldA });
      }

      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/components/B.tsx
      import { jsx as jsx2 } from "react/jsx-runtime";
  ...
  it('should handle GraphQL interfaces and unions via $on syntax', async () => {
    ...
    expect(out).toMatchInlineSnapshot(
      `
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/ProfileWithInterfaces.tsx
      import { useData } from "@getcronit/pylon/pages";
  ...
  it('should handle polymorphic rendering with $on and sub-components', async () => {
    ...
    expect(out).toMatchInlineSnapshot(
      `
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/ProfilePolymorphic.tsx
      import { useData } from "@getcronit/pylon/pages";

      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/components/PetComponents.tsx
      import { jsx } from "react/jsx-runtime";
  ...
  it('should NOT treat common JS methods or constructors as GraphQL selectors', async () => {
    ...
    expect(outputCode).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/JSInternals.tsx
      import { useData } from "@getcronit/pylon/pages";
  ...
  it('should handle query data passed to a helper function that returns a derived value', async () => {
    ...
    expect(outputCode).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/HelperFunction.tsx
      import { useData } from "@getcronit/pylon/pages";
      import { jsx, jsxs } from "react/jsx-runtime";
      function formatUser(user) {
        return user.firstName + " " + user.lastName + " (" + user.email + ")";
  ...
  it('should handle aliased useData imports', async () => {
    ...
    const outputCode = result.outputFiles[0].text
    expect(outputCode).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/AliasedImport.tsx
      import { useData as uq } from "@getcronit/pylon/pages";
      import { jsx } from "react/jsx-runtime";
      function App() {
        const { user } = uq({
  ...
  it('should handle circular hook dependencies safely', async () => {
    ...
    const outputCode = result.outputFiles[0].text
    expect(outputCode).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/hooks/circular.ts
      import { useData } from "@getcronit/pylon/pages";

      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/hooks/circularB.ts
      function useB() {
        return { name: "B" };
      }
      ...
      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/Circular.tsx
      import { jsx } from "react/jsx-runtime";
      function Page() {
        const a = useA();
  ...
  it('should handle destructuring with aliasing', async () => {
    ...
    const outputCode = result.outputFiles[0].text
    expect(outputCode).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/AliasDestructure.tsx
      import { useData } from "@getcronit/pylon/pages";
      import { jsx } from "react/jsx-runtime";
      function App() {
        const { currentUser: person } = useData({
  ...
  it('should handle object spread operator in hook returns', async () => {
    ...
    const outputCode = result.outputFiles[0].text
    expect(outputCode).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/hooks/spread.ts
      import { useData } from "@getcronit/pylon/pages";
      ...
      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/Spread.tsx
      import { jsxs } from "react/jsx-runtime";
      function Page() {
        const user = useEnhancedUser();
        return /* @__PURE__ */ jsxs("div", { children: [
  ...
  it('should handle shadowing + re-mapping in object returns', async () => {
    ...
    const outputCode = result.outputFiles[0].text
    expect(outputCode).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/hooks/complex.ts
      import { useData } from "@getcronit/pylon/pages";
      function useEnhancedUser() {
        const { user } = useData({
          prepare: ({ query: __pylonQuery }) => {
      ...
      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/Complex.tsx
      import { jsxs } from "react/jsx-runtime";
      function Page() {
        const user = useEnhancedUser();
        return /* @__PURE__ */ jsxs("div", { children: [
  ...
  it('should handle object rest operator in destructuring', async () => {
    ...
    const outputCode = result.outputFiles[0].text
    expect(outputCode).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/RestObject.tsx
      import { useData } from "@getcronit/pylon/pages";
      import { jsx } from "react/jsx-runtime";
      function Page() {
        const { user, ...rest } = useData({
  ...
  it('should handle array rest operator in destructuring', async () => {
    ...
    const outputCode = result.outputFiles[0].text
    expect(outputCode).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/RestArray.tsx
      import { useData } from "@getcronit/pylon/pages";
      import { jsx, jsxs } from "react/jsx-runtime";
      function Page() {
        const { posts } = useData({
  ...
  it('should handle default values in destructuring', async () => {
    ...
    const outputCode = result.outputFiles[0].text
    expect(outputCode).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/DefaultValue.tsx
      import { useData } from "@getcronit/pylon/pages";
      import { jsxs } from "react/jsx-runtime";
      function Page() {
        const { user = { displayName: "Guest" } } = useData({
  ...
  it('should handle nested scope cross-referencing', async () => {
    ...
    const outputCode = result.outputFiles[0].text
    expect(outputCode).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/NestedScope.tsx
      import { useData } from "@getcronit/pylon/pages";
      import { jsx, jsxs } from "react/jsx-runtime";
      function Page() {
        const { posts } = useData({
  ...
  it('should handle computed property names in hook returns', async () => {
    ...
    const outputCode = result.outputFiles[0].text
    expect(outputCode).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/hooks/computed.ts
      import { useData } from "@getcronit/pylon/pages";
      ...
      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/Computed.tsx
      import { jsx } from "react/jsx-runtime";
      function Page() {
        const data = useDynamicUser();
  ...
  it('should handle object methods in hook returns', async () => {
    ...
    const outputCode = result.outputFiles[0].text
    expect(outputCode).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/hooks/methods.ts
      import { useData } from "@getcronit/pylon/pages";
      ...
      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/Methods.tsx
      import { jsx } from "react/jsx-runtime";
      function Page() {
        const actions = useUserActions();
  ...
  it('should handle array.reduce in hook returns', async () => {
    ...
    const outputCode = result.outputFiles[0].text
    expect(outputCode).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/hooks/useData.ts
      var useData = () => ({ posts: [{ id: 1, title: "hello" }] });

      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/hooks/reduce.ts
      ...
      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/Reduce.tsx
      import { jsx } from "react/jsx-runtime";
      function Page() {
        const postsById = usePostsMap();
  ...
  it('should handle useData with an empty options object', async () => {
    ...
    const outputCode = result.outputFiles[0].text
    expect(outputCode).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/EmptyOptions.tsx
      import { useData } from "@getcronit/pylon/pages";
      import { jsx } from "react/jsx-runtime";
      function Page() {
        const data = useData({
  ...
  it('should handle multiple files where nodes are passed to a task component', async () => {
    ...
    const outputCode = result.outputFiles[0].text
    expect(outputCode).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/TasksPage.tsx
      import { useData } from "@getcronit/pylon/pages";

      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/components/Task.tsx
      import { jsx, jsxs } from "react/jsx-runtime";
      function Task({ node }) {
        return /* @__PURE__ */ jsxs("div", { children: [
  ...
  it('should handle multiple files where the whole nodes array is passed to a component', async () => {
    ...
    const outputCode = result.outputFiles[0].text
    expect(outputCode).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/AllTasksPage.tsx
      import { useData } from "@getcronit/pylon/pages";

      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/components/Tasks.tsx
      import { jsx } from "react/jsx-runtime";
  ...
  it('should handle alias imports by loading tsconfig from esbuild options', async () => {
    ...
    const out = result.outputFiles[0].text
    expect(out).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_tests/alias-app/pages/AliasPage.tsx
      import { useData } from "@getcronit/pylon/pages";

      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_tests/alias-app/components/UserBadge.tsx
      import { jsx } from "react/jsx-runtime";
  ...
  it('should handle a custom hook in a separate file with alias and index re-export', async () => {
    ...
    const outputCode = result.outputFiles[0].text
    expect(outputCode).toMatchInlineSnapshot(`
      "// test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/pages/TicketsPage.tsx
      import { useData } from "@getcronit/pylon/pages";

      // test/pages/plugins/use-pages/build/plugins/use-data-static-analyzer/temp_nextjs_app/hooks/useTicketInfo.ts

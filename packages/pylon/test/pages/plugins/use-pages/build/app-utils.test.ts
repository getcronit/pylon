...
describe('app-utils', () => {
  ...
  describe('scanDirectory', () => {
        ...
        children: [
          {
            path: undefined,
            index: true,
            lazy: `async () => {const i = await import("./../pages/page").catch((e) => {console.error("[pylon] failed to load route module", "./../pages/page", e); window.location.reload();}); return {Component: withRouteData(i.default, "Page", undefined)}}`,
            ...
            children: [
              {
                path: undefined,
                index: true,
                lazy: `async () => {const i = await import("./../pages/warehouse/page").catch((e) => {console.error("[pylon] failed to load route module", "./../pages/warehouse/page", e); window.location.reload();}); return {Component: withRouteData(i.default, "WarehousePage", undefined)}}`,
                HydrateFallback: 'HydrateFallback',
                errorElement: '<ErrorElement standalone={false} />'
              },
              {
                ...
                children: [
                  {
                    path: undefined,
                    index: true,
                    lazy: `async () => {const i = await import("./../pages/warehouse/stock/page").catch((e) => {console.error("[pylon] failed to load route module", "./../pages/warehouse/stock/page", e); window.location.reload();}); return {Component: withRouteData(i.default, "WarehouseStockPage", undefined)}}`,
                    HydrateFallback: 'HydrateFallback',
                    errorElement: '<ErrorElement standalone={false} />'
                  }
                ]
                ...
                children: [
                  {
                    path: undefined,
                    index: true,
                    lazy: `async () => {const i = await import("./../pages/warehouse/inventory/page").catch((e) => {console.error("[pylon] failed to load route module", "./../pages/warehouse/inventory/page", e); window.location.reload();}); return {Component: withRouteData(i.default, "WarehouseInventoryPage", undefined)}}`,
                    HydrateFallback: 'HydrateFallback',
                    errorElement: '<ErrorElement standalone={false} />'
                  }
                ]
            ...
            children: [
              {
                ...
                children: [
                  {
                    index: true,
                    lazy: 'async () => {const i = await import("./../pages/posts/[id]/page").catch((e) => {console.error("[pylon] failed to load route module", "./../pages/posts/[id]/page", e); window.location.reload();}); return {Component: withRouteData(i.default, "PostsIdPage", undefined)}}',
                    HydrateFallback: 'HydrateFallback',
                    errorElement: '<ErrorElement standalone={false} />'
                  }
                ]
    ...
    it('should handle catch-all routes', () => {
      ...
      expect(route).toMatchObject({
        path: '*',
        lazy: `async () => {const i = await import("./../pages/[...slug]/page").catch((e) => {console.error("[pylon] failed to load route module", "./../pages/[...slug]/page", e); window.location.reload();}); return {Component: withRouteData(i.default, "CatchAllSlugPage", "slug")}}`,
        HydrateFallback: 'HydrateFallback',
        errorElement: '<ErrorElement standalone={false} />'
      })
    })
            ...
            children: [
              {
                ...
                lazy: `async () => {const i = await import("./../pages/posts/[id]/[...slug]/page").catch((e) => {console.error("[pylon] failed to load route module", "./../pages/posts/[id]/[...slug]/page", e); window.location.reload();}); return {Component: withRouteData(i.default, "PostsIdCatchAllSlugPage", "slug")}}`,
              },
              {
                path: '*',
                element: '<NotFoundPage standalone={false} />'
        ...
        children: [
          {
            ...
            children: [
              {
                index: true,
                lazy: `async () => {const i = await import("./../pages/contact/page").catch((e) => {console.error("[pylon] failed to load route module", "./../pages/contact/page", e); window.location.reload();}); return {Component: withRouteData(i.default, "ContactPage", undefined)}}`,
                HydrateFallback: 'HydrateFallback',
                errorElement: '<ErrorElement standalone={false} />'
              }
            ]
                ...
                children: [
                  {
                    path: undefined,
                    index: true,
                    lazy: `async () => {const i = await import("./../pages/auth/login/page").catch((e) => {console.error("[pylon] failed to load route module", "./../pages/auth/login/page", e); window.location.reload();}); return {Component: withRouteData(i.default, "AuthLoginPage", undefined)}}`,
                    HydrateFallback: 'HydrateFallback',
                    errorElement: '<ErrorElement standalone={false} />'
                  }
                ]
                ...
                children: [
                  {
                    path: undefined,
                    index: true,
                    lazy: `async () => {const i = await import("./../pages/auth/register/page").catch((e) => {console.error("[pylon] failed to load route module", "./../pages/auth/register/page", e); window.location.reload();}); return {Component: withRouteData(i.default, "AuthRegisterPage", undefined)}}`,
                    HydrateFallback: 'HydrateFallback',
                    errorElement: '<ErrorElement standalone={false} />'
                  }
                ]
            ...
            children: [
              {
                path: undefined,
                index: true,
                lazy: `async () => {const i = await import("./../pages/dashboard/page").catch((e) => {console.error("[pylon] failed to load route module", "./../pages/dashboard/page", e); window.location.reload();}); return {Component: withRouteData(i.default, "DashboardPage", undefined)}}`,
                HydrateFallback: 'HydrateFallback',
                errorElement: '<ErrorElement standalone={false} />'
              },
              {
                ...
                children: [
                  {
                    path: undefined,
                    index: true,
                    lazy: `async () => {const i = await import("./../pages/dashboard/settings/page").catch((e) => {console.error("[pylon] failed to load route module", "./../pages/dashboard/settings/page", e); window.location.reload();}); return {Component: withRouteData(i.default, "DashboardSettingsPage", undefined)}}`,
                    HydrateFallback: 'HydrateFallback',
                    errorElement: '<ErrorElement standalone={false} />'
                  }
                ]
                ...
                children: [
                  {
                    path: undefined,
                    index: true,
                    lazy: `async () => {const i = await import("./../pages/dashboard/[teamId]/page").catch((e) => {console.error("[pylon] failed to load route module", "./../pages/dashboard/[teamId]/page", e); window.location.reload();}); return {Component: withRouteData(i.default, "DashboardTeamIdPage", undefined)}}`,
                    HydrateFallback: 'HydrateFallback',
                    errorElement: '<ErrorElement standalone={false} />'
                  },
                  {
                    ...
                    children: [
                      {
                        path: undefined,
                        index: true,
                        lazy: `async () => {const i = await import("./../pages/dashboard/[teamId]/[projectId]/page").catch((e) => {console.error("[pylon] failed to load route module", "./../pages/dashboard/[teamId]/[projectId]/page", e); window.location.reload();}); return {Component: withRouteData(i.default, "DashboardTeamIdProjectIdPage", undefined)}}`,
                        HydrateFallback: 'HydrateFallback',
                        errorElement: '<ErrorElement standalone={false} />'
                      }
                    ]
    ...
    return hasParamChanged || (relevantKeys.length === 0 && defaultShouldRevalidate);
          ...
          {
            path: 'files/*',
            lazy: `async () => {const i = await import("./../pages/files/[...id]/page").catch((e) => {console.error("[pylon] failed to load route module", "./../pages/files/[...id]/page", e); window.location.reload();}); return {Component: withRouteData(i.default, "FilesCatchAllIdPage", "id")}}`,
            HydrateFallback: 'HydrateFallback',
            errorElement: '<ErrorElement standalone={false} />'
          },
          {

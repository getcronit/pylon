...
Perfect! We have successfully implemented a simple class that holds in-memory data and provides methods to interact with it. We can now read and modify the data using the built-in GraphQL playground.

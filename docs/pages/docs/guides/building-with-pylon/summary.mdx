...
In addition, we looked at how we can incorporate different types of data sources ([hardcoded](./hardcoded-data), [external API](./external-api), and [Prisma/database](./integrating-prisma)).
